...
<title>Outlook Email Inbox using PHP with IMAP</title>
</head>

<body>
    <h1>Outlook Email Inbox using PHP with IMAP</h1>
    <?php
    ...
    <div id="listData" class="list-form-container">
        ...
        $connection = imap_open('{imap.outlook.com:993/imap/ssl}INBOX', 'pcmishra22@hotmail.com', 'kartik1234') or die('Cannot connect to Gmail: ' . imap_last_error());

        /* Search Emails having the specified keyword in the email subject */
        //$emailData = imap_search($connection, 'SUBJECT "Article "');
        //$emailData = imap_search($connection, 'SINCE "01 Jan 2020"');
        ...
        if (! empty($emailData)) {
            ...
            foreach ($emailData as $emailIdent) {
                ...
                <tr>
                        ...
                        <td style="width:15%;"><span class="column"><?php echo $message; ?></span></td>
