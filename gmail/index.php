...
<body>
    ...
    <div id="listData" class="list-form-container">
        ...
        $connection = imap_open('{imap.gmail.com:993/imap/ssl}INBOX', 'pcmishra22@gmail.com', '1234root5678') or die('Cannot connect to Gmail: ' . imap_last_error());

        /* Search Emails having the specified keyword in the email subject */
        //$emailData = imap_search($connection, 'SUBJECT "Article "');
        //$emailData = imap_search($connection, 'SINCE "01 Jan 2020"');
        $emailData = imap_search($connection, 'SINCE '. date('d-M-Y',strtotime("-1 week")));
